...
class BookingCollaboratorController extends Controller
{
    public function index()
    {
        ...
        $rooms = Room::with(['bookings' => function ($query) use ($userId) {
    ...
    public function store(Request $request, Room $room)
    {
        ...
        return redirect()->route('booking.booking_collaborator.index')->with('success', 'Room successfully booked!');
    }
    ...
    public function show(Room $room, Request $request)
    {
        $query = Booking::with('user')
            ...
            ->where('user_id', auth()->id()); // Limita ao usuário autenticado
        ...
        return view('app.business.booking.booking_collaborator.bookings_collaborator_show', compact('room', 'bookings'));
    }
