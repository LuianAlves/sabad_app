                    ...
                    <div class="card border shadow-xs h-100">
                        ...
                        <div class="card-body p-3">
                            <p class="text-sm mb-4">
                                {{ $employee->name }}, entrou em {{ \Carbon\Carbon::parse($employee->hired_in)->format('d/m/Y') }} ({{ \Carbon\Carbon::parse($employee->hired_in)->diffForHumans() }}) na equipe do (a) {{ $employee->department->name }}
                                pela empresa {{ $employee->department->company->name }}. <br> Seu cargo atual é <b>{{ $employee->hierarchical_level }}</b>.
                            </p>
                            <ul class="list-group">
                        ...
                        <div class="card-header pb-0 p-3">
                            <div class="row mb-sm-0 mb-2">
                                <div class="col-md-8 col-9">
                                    ...
                                    <p class="text-sm mb-0">{{ '/ '.$employee->department->name .' - '. Str::words($employee->department->company->name, 1, ' ..') }}</p>
                                </div>
                                <div class="col-md-4 col-3 text-end">
                                    <button type="button" class="btn btn-white btn-icon px-2 py-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
