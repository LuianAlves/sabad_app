        ...
        <div class="container my-3 py-3">
            <div class="row">
                                    ...
                                    <li class="list-group-item border-0 d-flex align-items-center px-0 mb-1">
                                        <div class="avatar avatar-sm rounded-circle me-2">
                                            @if ($team->employeeUser?->user?->image)
                                                <img
                                                    src="{{ 'data:image/png;base64,' . $team->employeeUser->user->image }}"
                                        ...
                                        <div class="d-flex align-items-start flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm font-weight-semibold d-flex align-items-center">
                                                ...
                                                @if ($unreadCount > 0)
                                                    <span
                                                        class="badge rounded-pill bg-danger notification-badge ms-2"
                                                        data-user-id="{{ $team->employeeUser->user->id }}"
                                                        style="
                ...
                <div class="col-12 col-xl-4 mb-4">
                    <div class="card border shadow-xs h-100">
                        <div class="card-header p-3">
                            <h6 class="mb-0 font-weight-semibold text-lg">Controle de Documentos</h6>
                        </div>
