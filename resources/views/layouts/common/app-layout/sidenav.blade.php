...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse px-4 w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @can('view services')
                <li class="nav-item border-start my-0 pt-2">
                    <a class="nav-link p-0 {{ $current == 'service' ? 'active' : '' }}"
            ...
            @can('view licenses')
                <li class="nav-item border-start my-0 pt-2">
                    <a class="nav-link p-0 {{ $current == 'license' ? 'active' : '' }}"
            ...
            @can('view devices')
                <li class="nav-item border-start my-0 pt-2">
                    <a class="nav-link p-0 {{ $current == 'device' ? 'active' : '' }}"
            ...
            @can('view tickets')
                <li class="nav-item border-start my-0 pt-2">
                    <a class="nav-link p-0 {{ $current == 'ticket' ? 'active' : '' }}"
            ...
            @can('view domains')
                <li class="nav-item border-start my-0 pt-2">
                    <a class="nav-link p-0 {{ $current == 'domain' ? 'active' : '' }}"
