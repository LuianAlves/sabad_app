...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start bg-white" id="sidenav-main">
    <div class="sidenav-header pt-2">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg" style="font-size: 36px !important; letter-spacing: 1px !important;"><span class="text-info">D</span>ry<span class="text-info">L</span>u</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $current == 'extension' ? 'active' : '' }}" href="{{ route('extension.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $current == 'notifications' ? 'active' : '' }}"
                   href="{{ route('notifications.create') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-bell"></i>
                    </div>
                    <span class="nav-link-text ms-1">Criar Notificação</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ $current == 'record_controls' ? 'active' : '' }}"
                   href="{{ route('record_controls.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-file"></i>
                    </div>
                    <span class="nav-link-text ms-1">Controle de Docs</span>
                </a>
            </li>
