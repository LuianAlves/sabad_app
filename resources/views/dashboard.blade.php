            ...
            <div class="card shadow-xs border h-100">
                ...
                <div class="btn-group" role="group" aria-label="Filtro por empresa">
                    ...
                    @foreach ($companies as $company)
                        ...
                        <label class="btn btn-white px-3 mb-0"
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex px-2">
                                            <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                <img src="../img/small-logos/logo-spotify.svg" class="w-80"
                                                    alt="spotify">
                                            </div>
                                            <div class="my-auto">
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex">
                                            <div
                                                ...
                                                <img src="../img/logos/visa.png" class="w-90 mx-auto" alt="visa">
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2">
                                            <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                <img src="../img/small-logos/logo-invision.svg" class="w-80"
                                                    alt="invision">
                                            </div>
                                            <div class="my-auto">
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex">
                                            <div
                                                class="border px-1 py-1 text-center d-flex align-items-center border-radius-sm my-auto">
                                                <img src="../img/logos/mastercard.png" class="w-90 mx-auto"
                                                    alt="mastercard">
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2">
                                            <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                <img src="../img/small-logos/logo-jira.svg" class="w-80"
                                                    alt="jira">
                                            </div>
                                            <div class="my-auto">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2">
                                            <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                <img src="../img/small-logos/logo-slack.svg" class="w-80"
                                                    alt="slack">
                                            </div>
                                            <div class="my-auto">
